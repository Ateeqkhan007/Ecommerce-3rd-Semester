    ...
    <footer className="bg-white border-t mt-12">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li><Link href="/" className="hover:text-primary">Deals & Promotions</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li><Link href="/" className="hover:text-primary">Track Your Order</Link></li>
          ...
          <div>
            ...
            <form className="mb-4" onSubmit={handleNewsletterSubmit}>
              <div className="flex">
                <Input 
                  ...
                  className="rounded-l-md focus:ring-primary focus:border-primary"
                />
                <Button 
                  type="submit" 
            ...
            <div className="flex space-x-2">
              <div className="h-8 w-12 bg-blue-600 rounded flex items-center justify-center text-white font-bold">
                VI
              </div>
              <div className="h-8 w-12 bg-red-600 rounded flex items-center justify-center text-white font-bold">
                MC
              </div>
              <div className="h-8 w-12 bg-blue-400 rounded flex items-center justify-center text-white font-bold">
                PP
              </div>
              <div className="h-8 w-12 bg-gray-800 rounded flex items-center justify-center text-white font-bold">
                AE
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-6 border-t text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} ShopEase. All rights reserved. This is a college project.</p>
        </div>
      </div>
    </footer>
  );
